...
QT_MOC_LITERAL(5, 52, 10), // "disconnect"
QT_MOC_LITERAL(6, 63, 4) // "quit"

    },
    "Consumer\0error\0\0QTcpSocket::SocketError\0"
    "socketError\0disconnect\0quit"
};
...
void Consumer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Consumer::*_t)(QTcpSocket::SocketError );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Consumer::error)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Consumer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Consumer::disconnect)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Consumer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Consumer::quit)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject Consumer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Consumer.data,
...
// SIGNAL 0
void Consumer::error(QTcpSocket::SocketError _t1)
{
